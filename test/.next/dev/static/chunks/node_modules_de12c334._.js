...
function x(e, t = !0) {
    var o, s;
    let r = t && (s = (o = Y) == null ? void 0 : o[e]) != null ? s : e, n = t ? Y.code : Me;
    return new z(r, n);
}
var z = class {
...
var dt = Object.values(K), xe = (e)=>typeof e == "boolean" || typeof e == "string" && dt.includes(e), Re = (e, t, r)=>{
    ...
    if (i(), v(t, "loadstart", ()=>{
        ...
        r || (e.streamType && e.streamType !== _.UNKNOWN ? s = e.streamType === _.LIVE : s = !Number.isFinite(t.duration)), te(t, a);
    }, {
        once: !0
    }), r && r.once(g.Events.LEVEL_LOADED, (u, c)=>{
        var d;
        e.streamType && e.streamType !== _.UNKNOWN ? s = e.streamType === _.LIVE : s = (d = c.details.live) != null ? d : !1;
    }), !a) {
        let u = ()=>{
...
var be = ({ preload: e, src: t }, r, n)=>{
    ...
    if (!n) return o(e), o;
    let s = !1, a = !1, i = n.config.maxBufferLength, l = n.config.maxBufferSize, u = (d)=>{
        o(d);
        let p = d != null ? d : r.preload;
        a || p === "none" || (p === "metadata" ? (n.config.maxBufferLength = 1, n.config.maxBufferSize = 1) : (n.config.maxBufferLength = i, n.config.maxBufferSize = l), c());
    }, c = ()=>{
        !s && t && (s = !0, n.loadSource(t));
    };
    return v(r, "play", ()=>{
        a = !0, n.config.maxBufferLength = i, n.config.maxBufferSize = l, c();
    }, {
        once: !0
    }), u(e), u;
};
function De(e, t) {
    ...
    let r = new WeakMap;
    t.on(g.Events.MANIFEST_PARSED, function(l, u) {
        a();
        let c = e.addVideoTrack("main");
        c.selected = !0;
        for (let [d, p] of u.levels.entries()){
            let T = c.addRendition(p.url[0], p.width, p.height, p.videoCodec, p.bitrate);
            r.set(p, `${d}`), T.id = `${d}`;
        }
    }), t.on(g.Events.AUDIO_TRACKS_UPDATED, function(l, u) {
        s();
        for (let c of u.audioTracks){
            let d = c.default ? "main" : "alternative", p = e.addAudioTrack(d, c.name, c.lang);
            p.id = `${c.id}`, c.default && (p.enabled = !0);
        }
    }), e.audioTracks.addEventListener("change", ()=>{
        var c;
        let l = +((c = [
            ...e.audioTracks
        ].find((d)=>d.enabled)) == null ? void 0 : c.id), u = t.audioTracks.map((d)=>d.id);
        l != t.audioTrack && u.includes(l) && (t.audioTrack = l);
    }), t.on(g.Events.LEVELS_UPDATED, function(l, u) {
        var p;
        let c = e.videoTracks[(p = e.videoTracks.selectedIndex) != null ? p : 0];
        if (!c) return;
        let d = u.levels.map((T)=>r.get(T));
        for (let T of e.videoRenditions)T.id && !d.includes(T.id) && c.removeRendition(T);
    });
    let n = (l)=>{
        let u = l.target.selectedIndex;
        u != t.nextLevel && (t.nextLevel = u);
    };
    (i = e.videoRenditions) == null || i.addEventListener("change", n);
    let o = ()=>{
        for (let l of e.videoTracks)e.removeVideoTrack(l);
    }, s = ()=>{
        for (let l of e.audioTracks)e.removeAudioTrack(l);
    }, a = ()=>{
        o(), s();
    };
    t.once(g.Events.DESTROYING, a);
}
var re = (e)=>"time" in e ? e.time : e.startTime;
function Ce(e, t) {
    t.on(g.Events.NON_NATIVE_TEXT_TRACKS_FOUND, (o, { tracks: s })=>{
        s.forEach((a)=>{
            var c, d;
            let i = (c = a.subtitleTrack) != null ? c : a.closedCaptions, l = t.subtitleTracks.findIndex(({ lang: p, name: T, type: m })=>p == (i == null ? void 0 : i.lang) && T === a.label && m.toLowerCase() === a.kind), u = ((d = a._id) != null ? d : a.default) ? "default" : `${a.kind}${l}`;
            ne(e, a.kind, a.label, i == null ? void 0 : i.lang, u, a.default);
        });
    });
    let r = ()=>{
        ...
        if (t.subtitleTrack < 0 || (o == null ? void 0 : o.id) !== a) {
            let i = t.subtitleTracks.findIndex(({ lang: l, name: u, type: c, default: d })=>o.id === "default" && d || l == o.language && u === o.label && c.toLowerCase() === o.kind);
            t.subtitleTrack = i;
        }
    ...
    e.textTracks.addEventListener("change", r), t.on(g.Events.CUES_PARSED, (o, { track: s, cues: a })=>{
        let i = e.textTracks.getTrackById(s);
        if (!i) return;
        let l = i.mode === "disabled";
        l && (i.mode = "hidden"), a.forEach((u)=>{
            var c;
            (c = i.cues) != null && c.getCueById(u.id) || i.addCue(u);
        }), l && (i.mode = "disabled");
...
async function ve(e, t, r, n) {
    let o = w(e, r, n);
    return o || (o = ne(e, n, r), o.mode = "hidden", await new Promise((s)=>setTimeout(()=>s(void 0), 0))), o.mode !== "hidden" && (o.mode = "hidden"), [
        ...t
    ].sort((s, a)=>re(a) - re(s)).forEach((s)=>{
        var l, u;
        let a = s.value, i = re(s);
        if ("endTime" in s && s.endTime != null) o == null || o.addCue(new VTTCue(i, s.endTime, n === "chapters" ? a : JSON.stringify(a != null ? a : null)));
        else {
            let c = Array.prototype.findIndex.call(o == null ? void 0 : o.cues, (m)=>m.startTime >= i), d = (l = o == null ? void 0 : o.cues) == null ? void 0 : l[c], p = d ? d.startTime : Number.isFinite(e.duration) ? e.duration : Number.MAX_SAFE_INTEGER, T = (u = o == null ? void 0 : o.cues) == null ? void 0 : u[c - 1];
            T && (T.endTime = i), o == null || o.addCue(new VTTCue(i, p, n === "chapters" ? a : JSON.stringify(a != null ? a : null)));
        }
...
var se = {
    ...
    var o, s;
    let r = V(e), n = `${r}Token`;
    return (o = t.tokens) != null && o[r] ? (s = t.tokens) == null ? void 0 : s[r] : O(n, t) ? t[n] : void 0;
}, H = (e, t, r, n, o = !1, s = !((a)=>(a = globalThis.navigator) == null ? void 0 : a.onLine)())=>{
    var M, h;
    if (s) {
    ...
    let i = "status" in e ? e.status : e.code, l = Date.now(), u = f.MEDIA_ERR_NETWORK;
    if (i === 200) return;
    let c = V(t), d = Et(t, r), p = mt(t), [T] = F((M = r.playbackId) != null ? M : "");
    if (!i || !T) return;
    let m = ee(d);
    if (d && !m) {
    ...
    if (i === 403) if (m) {
        if (ye(m, l)) {
            let b = {
                ...
                currentDate: new Intl.DateTimeFormat("en", b).format(l)
            }), k = new f(E, u, !0, y);
...
var Se = g.DefaultConfig.capLevelController, j = class j extends Se {
    ...
    getMaxLevel(t) {
        ...
        if (!n[r]) return r;
        let o = Math.min(n[r].width, n[r].height), s = j.minMaxResolution;
        return o >= s ? r : Se.getMaxLevelByMediaSize(n, s * (16 / 9), s);
    }
};
...
var Dt = (e)=>{
    var i, l, u;
    let t = e.split(`
`), n = (l = ((i = t.find((c)=>c.startsWith("#EXT-X-PLAYLIST-TYPE"))) != null ? i : "").split(":")[1]) == null ? void 0 : l.trim(), o = Q(n), s = Z(n), a;
    if (o === _.LIVE) {
        let c = t.find((p)=>p.startsWith("#EXT-X-PART-INF"));
        if (!!c) a = +c.split(":")[1].split("=")[1] * 2;
        else {
            let p = t.find((R)=>R.startsWith("#EXT-X-TARGETDURATION")), T = (u = p == null ? void 0 : p.split(":")) == null ? void 0 : u[1];
            a = +(T != null ? T : 6) * 3;
        }
    }
    return {
    ...
    (i != null && i.URI || i != null && i.VALUE.toLocaleLowerCase().startsWith("http")) && de((l = i.URI) != null ? l : i.VALUE, t), ((u = P.get(t)) != null ? u : {}).liveEdgeStartOffset = s, ((c = P.get(t)) != null ? c : {}).targetLiveWindow = o, t.dispatchEvent(new CustomEvent("targetlivewindowchange", {
        composed: !0,
        bubbles: !0
    })), ((d = P.get(t)) != null ? d : {}).streamType = n, t.dispatchEvent(new CustomEvent("streamtypechange", {
        composed: !0,
        bubbles: !0
    }));
}, de = async (e, t)=>{
    ...
    var a;
    let t = e.type, r = Q(t), n = Z(t), o, s = !!((a = e.partList) != null && a.length);
    ...
    if (n === _.LIVE) {
        a ? (r.config.backBufferLength = (i = r.userConfig.backBufferLength) != null ? i : 4, r.config.maxFragLookUpTolerance = (l = r.userConfig.maxFragLookUpTolerance) != null ? l : .001, r.config.abrBandWidthUpFactor = (u = r.userConfig.abrBandWidthUpFactor) != null ? u : r.config.abrBandWidthFactor) : r.config.backBufferLength = (c = r.userConfig.backBufferLength) != null ? c : 8;
        let R = Object.freeze({
            get length () {
        ...
        ((d = P.get(t)) != null ? d : {}).seekable = R;
    }
    ((p = P.get(t)) != null ? p : {}).liveEdgeStartOffset = s, ((T = P.get(t)) != null ? T : {}).targetLiveWindow = o, t.dispatchEvent(new CustomEvent("targetlivewindowchange", {
        composed: !0,
        bubbles: !0
    ...
    let r = t.currentLevel >= 0 ? (c = (u = t.levels) == null ? void 0 : u[t.currentLevel]) == null ? void 0 : c.details : (d = t.levels.find((p)=>!!p.details)) == null ? void 0 : d.details;
    if (!r || r.live) return;
    let { fragments: n } = r;
    ...
    Kt(t, r, e);
    let { metadata: n = {} } = e, { view_session_id: o = St() } = n, s = wt(e);
...
function Ze(e, t) {
    ...
    let o = !r || ((u = t.canPlayType(r)) != null ? u : !0), { preferPlayback: s } = e, a = s === X.MSE, i = s === X.NATIVE, l = Ge && (a || At(t));
    return o && (i || !l);
}
var Wt = (e, t)=>{
    let { debug: r, streamType: n, startTime: o = -1, metadata: s, preferCmcd: a, _hlsConfig: i = {} } = e, u = U(e) === I.M3U8, c = Ze(e, t);
    if (u && !c && Ge) {
        let d = {
            backBufferLength: 30,
    ...
    return !t || !o ? {} : {
        ...
        requestMediaKeySystemAccessFunc: (s, a)=>(s === "com.widevine.alpha" && (a = [
                ...a.map((i)=>{
                    var u;
                    let l = (u = i.videoCapabilities) == null ? void 0 : u.map((c)=>({
                            ...c,
        ...
        try {
            ...
            if (!t.mediaKeys) {
                let u = await navigator.requestMediaKeySystemAccess("com.apple.fps", [
                    ...
                    let d = x("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), p = new f(d, f.MEDIA_ERR_ENCRYPTED, !0);
                    p.errorCategory = C.DRM, p.muxCode = D.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM, N(t, p);
                });
                if (!u) return;
                let c = await u.createMediaKeys();
                try {
                    let d = await $t(et(e, "fairplay")).catch((p)=>{
                    ...
                    await c.setServerCertificate(d).catch(()=>{
                        let p = x("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."), T = new f(p, f.MEDIA_ERR_ENCRYPTED, !0);
            ...
            a.addEventListener("keystatuseschange", ()=>{
                a.keyStatuses.forEach((u)=>{
                    let c;
                    if (u === "internal-error") {
                        let d = x("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");
                        c = new f(d, f.MEDIA_ERR_ENCRYPTED, !0), c.errorCategory = C.DRM, c.muxCode = D.ENCRYPTED_CDM_ERROR;
                    } else if (u === "output-restricted" || u === "output-downscaled") {
                        let d = x("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");
                        c = new f(d, f.MEDIA_ERR_ENCRYPTED, !1), c.errorCategory = C.DRM, c.muxCode = D.ENCRYPTED_OUTPUT_RESTRICTED;
                    }
                    c && N(t, c);
                });
            });
            let i = await Promise.all([
                a.generateRequest(o, s).catch(()=>{
                    let u = x("Failed to generate a DRM license request. This may be an issue with the player or your protected content."), c = new f(u, f.MEDIA_ERR_ENCRYPTED, !0);
                    c.errorCategory = C.DRM, c.muxCode = D.ENCRYPTED_GENERATE_REQUEST_FAILED, N(t, c);
                }),
                new Promise((u)=>{
            ...
            ]).then(([, u])=>u), l = await Bt(i, G(e, "fairplay")).catch((u)=>{
                if (u instanceof Response) {
                    let c = H(u, C.DRM, e);
                    return console.error("mediaError", c == null ? void 0 : c.message, c == null ? void 0 : c.context), c ? Promise.reject(c) : Promise.reject(new Error("Unexpected error in license key request"));
                }
                return Promise.reject(u);
            });
            await a.update(l).catch(()=>{
                let u = x("Failed to update DRM license. This may be an issue with the player or your protected content."), c = new f(u, f.MEDIA_ERR_ENCRYPTED, !0);
                return c.errorCategory = C.DRM, c.muxCode = D.ENCRYPTED_UPDATE_LICENSE_FAILED, Promise.reject(c);
            });
        } catch (o) {
            N(t, o);
            return;
    ...
    if (!o && (n || i)) {
        let { playerInitTime: u, playerSoftwareName: c, playerSoftwareVersion: d, beaconCollectionDomain: p, debug: T, disableCookies: m } = e, R = {
            ...e.metadata,
    ...
    let n = Ze(e, t), { src: o, customDomain: s = A } = e, a = ()=>{
        ...
        let p = Xe(t), T, m;
        p.length > 0 && (T = p.start(0), m = p.end(0)), (l !== m || i !== T) && t.dispatchEvent(new CustomEvent("seekablechange", {
            composed: !0
        })), i = T, l = m;
    };
    if (v(t, "durationchange", u), t && n) {
        ...
        if (typeof o == "string") {
            if (o.endsWith(".mp4") && o.includes(s)) {
                let R = qe(o), M = new URL(`https://stream.${s}/${R}/metadata.json`);
                de(M.toString(), t);
            }
            let T = ()=>{
            ...
            }, m = async ()=>vt(o, t, p).then(T).catch((R)=>{
            ...
            (c = e.tokens) != null && c.drm ? jt(e, t) : v(t, "encrypted", ()=>{
                ...
                once: !0
            }), t.setAttribute("src", o), e.startTime && (((d = P.get(t)) != null ? d : {}).startTime = e.startTime, t.addEventListener("durationchange", rt, {
                once: !0
            }));
    ...
    } else r && o ? (r.once(g.Events.LEVEL_LOADED, (p, T)=>{
    ...
    }), t.addEventListener("error", ce), v(t, "waiting", a), De(e, r), Ce(t, r), r.attachMedia(t)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function rt(e) {
    var n;
...
async function nt(e) {
    ...
    if (t.src && n === f.MEDIA_ERR_SRC_NOT_SUPPORTED && t.readyState === HTMLMediaElement.HAVE_NOTHING) {
        setTimeout(()=>{
            var a;
            let s = (a = Ot(t)) != null ? a : t.error;
            (s == null ? void 0 : s.code) === f.MEDIA_ERR_SRC_NOT_SUPPORTED && N(t, o);
        }, 500);
        return;
    }
...
var qt = (e, t)=>{
    ...
    let n = {
        ...
        ].includes(d.details) ? f.MEDIA_ERR_NETWORK : n[d.type], s = (d)=>{
        if (d.type === g.ErrorTypes.KEY_SYSTEM_ERROR) return C.DRM;
        if (d.type === g.ErrorTypes.NETWORK_ERROR) return C.VIDEO;
    }, a, i = o(e);
    if (i === f.MEDIA_ERR_NETWORK && e.response) {
        let d = (l = s(e)) != null ? l : C.VIDEO;
        a = (u = H(e.response, d, t, e.fatal)) != null ? u : new f("", i, e.fatal);
    } else if (i === f.MEDIA_ERR_ENCRYPTED) if (e.details === g.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) {
        let d = x("Attempting to play DRM-protected content without providing a DRM token.");
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_MISSING_TOKEN;
        ...
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM;
    } else if (e.details === g.ErrorDetails.KEY_SYSTEM_NO_SESSION) {
        let d = x("Failed to generate a DRM license request. This may be an issue with the player or your protected content.");
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, !0), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_GENERATE_REQUEST_FAILED;
    } else if (e.details === g.ErrorDetails.KEY_SYSTEM_SESSION_UPDATE_FAILED) {
        let d = x("Failed to update DRM license. This may be an issue with the player or your protected content.");
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_UPDATE_LICENSE_FAILED;
    } else if (e.details === g.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_UPDATE_FAILED) {
        let d = x("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate.");
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_UPDATE_SERVER_CERT_FAILED;
    } else if (e.details === g.ErrorDetails.KEY_SYSTEM_STATUS_INTERNAL_ERROR) {
        let d = x("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_CDM_ERROR;
    } else if (e.details === g.ErrorDetails.KEY_SYSTEM_STATUS_OUTPUT_RESTRICTED) {
        let d = x("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");
        a = new f(d, f.MEDIA_ERR_ENCRYPTED, !1), a.errorCategory = C.DRM, a.muxCode = D.ENCRYPTED_OUTPUT_RESTRICTED;
...
var e = {
    ...
    TYPE: "type",
    LOGO: "logo"
}, at = Object.values(e), v = P(), x = "mux-video", E, g, p, m, _, O, I, R, M, c, f, T, K = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"] {
    constructor(){
        super();
        d(this, f);
        d(this, E);
        ...
        d(this, M);
        d(this, c, "");
        o(this, p, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generatePlayerInitTime"])()), this.nativeEl.addEventListener("muxmetadata", (t)=>{
            var l;
    ...
    get playerInitTime() {
        return this.hasAttribute(e.PLAYER_INIT_TIME) ? +this.getAttribute(e.PLAYER_INIT_TIME) : n(this, p);
    }
    ...
    get liveEdgeStart() {
        ...
        if (this.hasAttribute(e.LIVE_EDGE_OFFSET)) {
            let { liveEdgeOffset: r } = this, l = (t = this.nativeEl.seekable.end(0)) != null ? t : 0, A = (i = this.nativeEl.seekable.start(0)) != null ? i : 0;
    ...
    set metadata(t) {
        o(this, m, t != null ? t : {}), this.mux && this.mux.emit("hb", n(this, m));
    }
    get _hlsConfig() {
        return n(this, O);
    }
    ...
    attributeChangedCallback(t, i, r) {
        ...
        switch(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"].observedAttributes.includes(t) && ![
            ...
            case "src":
                {
                    let u = !!i, h = !!r;
                    !u && h ? b(this, f, T).call(this) : u && !h ? this.unload() : u && h && (this.unload(), b(this, f, T).call(this));
                    break;
                }
            case "autoplay":
                if (r === i) break;
                (A = n(this, E)) == null || A.setAutoplay(this.autoplay);
                break;
            case "preload":
                if (r === i) break;
            ...
            case e.DISABLE_TRACKING:
                {
                    if (r == null || r !== i) {
                        ...
                        this.unload(), b(this, f, T).call(this).then(()=>{
    ...
    connectedCallback() {
        var t;
        (t = super.connectedCallback) == null || t.call(this), this.nativeEl && this.src && !n(this, E) && b(this, f, T).call(this);
    }
...
E = new WeakMap, g = new WeakMap, p = new WeakMap, m = new WeakMap, _ = new WeakMap, O = new WeakMap, I = new WeakMap, R = new WeakMap, M = new WeakMap, c = new WeakMap, f = new WeakSet, T = async function() {
    n(this, g) || (await o(this, g, Promise.resolve()), o(this, g, null), this.load());
};
;
