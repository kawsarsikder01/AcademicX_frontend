...
async function middleware(request) {
    ...
    if (!vendor_token) {
        if (pathname.startsWith("/vendor") && pathname !== "/vendor/login") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/vendor/login", request.url));
        }
    }
    if (vendor_token) {
        if (pathname === "/vendor/login") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/vendor/dashboard", request.url));
        }
    }
    if (!user_token) {
    ...
    if (user_token) {
        if (pathname === "/login" || pathname === "/register") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/student/portal", request.url));
        }
    }
